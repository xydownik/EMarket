...
DATABASES = {
    'default': dj_database_url.parse(os.getenv('DATABASE_URL', 'postgresql://admin:Bi1QLlMEzVGPz4D7NYqOtjOSGakv2aLE@dpg-culpl4q3esus73d1al2g-a.oregon-postgres.render.com/new_db_s2co')),

    'replica2': dj_database_url.parse(os.getenv('DATABASE_URL', 'postgresql://admin:Bi1QLlMEzVGPz4D7NYqOtjOSGakv2aLE@dpg-culpl4q3esus73d1al2g-a.oregon-postgres.render.com/new_db_s2co'))
}
